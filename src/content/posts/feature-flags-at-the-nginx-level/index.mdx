---
title: "Feature Flags at the Nginx Level"
published: 2023-10-23T00:00:00.000Z
description: >-
  Let's explore the potential of feature flags with Nginx: from setup to real-world
  transitions between Next.js and Nuxt
tags:
  - Nginx
  - Next.js
  - Nuxt
category: Hands-on
image: /assets/feature-flag-nginx/banner.png
ogImage: /assets/feature-flag-nginx/banner.png
---

import { Image } from "astro:assets";

import firstPageSrc from "./config_cat_first_page.png";
import configuringFlagSrc from "./configuring_flag.png";
import flagSpecSrc from "./flag_spec.png";
import showcaseSrc from "./showcase.mp4";
...
<figcaption class="text-center text-xs italic">
  <strong>Figure 1:</strong> Your initial glimpse upon entering the ConfigCat
  auditorium
</figcaption>

![ALT](./config_cat_first_page.png "Your initial glimpse upon entering the ConfigCat auditorium")
...
<figcaption class="text-center text-xs italic">
  <strong>Figure 4:</strong> The seamless transition between Next.js and Nuxt,
  directed live by our feature flag.
</figcaption>
